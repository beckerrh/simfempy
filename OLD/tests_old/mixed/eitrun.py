...
def test(nholes=2, percrandom = 0., plot=True):
    ...
    optimizer = OLD.simfempy.solvers.optimize.Optimizer(eit, nparam=nholes, nmeasure=nmeasures, regularize=regularize, param0=eit.diffinv2param(diffinv0))
    ...
    latex = OLD.simfempy.tools.latexwriter.LatexWriter(filename="mincompare_{}".format(nholes))
...
def plotJhat():
    ...
    optimizer = OLD.simfempy.solvers.optimize.Optimizer(eit, nparam=nholes, nmeasure=nmeasures)
