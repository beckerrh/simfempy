...
from OLD.simfempy import Elasticity
...
def mesh_traction(hmean, geomname="unitcube", x=[-1,1], y=[-1,1], z=[-1,1]):
    ...
    if geomname == "unitsquare":
        ...
        geometry = OLD.simfempy.meshes.geomdefs.unitcube.Unitcube(x, y, z)
    else:
...
def test_solvers():
    ...
    for i,hmean in enumerate(hmeans):
        ...
        # solvers = ['pyamg']
        timer = OLD.simfempy.tools.timer.Timer(name="elasticity n={}".format(n))
