...
from OLD.simfempy import Elliptic


# ----------------------------------------------------------------#
def test_analytic(exactsolution="Quadratic", geomname="unitsquare", verbose=2):
    bdrycond0 = OLD.simfempy.applications.problemdata.BoundaryConditions()
    bdrycond1 = OLD.simfempy.applications.problemdata.BoundaryConditions()
    postproc0 = {}
    postproc1 = {}
