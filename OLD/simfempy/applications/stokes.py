...
class Stokes(OLD.simfempy.solvers.solver.Solver):
    ...
    def __init__(self, **kwargs):
        ...
        if 'fem' in kwargs:
            ...
            fem = 'cr1'
        if fem == 'p1':
            self.femv = OLD.simfempy.fems.femp1sys.FemP1()
            raise NotImplementedError("p1 not ready")
        elif fem == 'cr1':
            self.femp = OLD.simfempy.fems.femd0.FemD0()
            self.femv = OLD.simfempy.fems.femcr1sys.FemCR1()
        else:
        ...
        if 'rhsmethod' in kwargs:
            ...
            if self.problemdata.rhsmethod == "rt":
                self.femrt = OLD.simfempy.fems.femrt0.FemRT0()
