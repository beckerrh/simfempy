...
def test(dim, **kwargs):
    ...
    paramargs['dirichletmethod'] = kwargs.pop('dirichletmethod', ['nitsche','strong','new'])
...
if __name__ == '__main__':
    ...
    test(dim=3, exactsolution = 'Linear', fem=['cr1'], niter=3, linearsolver='umf', dirichletmethod=['nitsche'], kheat=0.12, plotsolution=False)
