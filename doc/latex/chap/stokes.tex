...
\begin{aligned}
v_n =& \vn\\
\lambda_R v_{\northo} + \mu \northo\frac{\partial v}{\partial n}  =& \gortho 
\end{aligned}
\right.
%
\quad \mbox{in $\GammaR$}
...
+ \lambda_R\int_{\Gamma_R}v_{\northo} \phi_{\northo},\\
 l_{\Omega}(\phi,\xi) &:= \int_{\Omega} f\cdot\phi + \int_{\Omega} g\xi + \int_{\GammaR}\gortho \phi_{\northo}
...
+\int_{\Omega} \div v \xi+ \lambda_R\int_{\Gamma_R}v_{\northo} \phi_{\northo}
\end{align*}
%
...
= \int_{\partial\Omega} p\phi_n - \int_{\partial\Omega} \mu\dn{v}\cdot\phi -\int_{\GammaN} \pN\phi_n+ \int_{\Gamma_R}\left(\gortho - \lambda_Rv_{\northo}\right) \phi_{\northo}
\end{align*}
%
...
%
\begin{align*}
\int_{\Gamma_N} \left( (p-\pN)\phi_n - \mu\dn{v}\cdot\phi\right) + \int_{\Gamma_R}\left(\gortho - \lambda_Rv_{\northo} - \mu\dn{v}\cdot\phi_{\northo}\right) \phi_{\northo}=0
\end{align*}
%
\end{proof}
%
...
%
\begin{align*}
-\int_{\Gamma_N} \left( \sigma n + \pN n \right)\cdot\phi + \int_{\Gamma_R}\left(\gortho - \lambda_Rv_{\northo} - \sigma n \cdot \northo \right) \phi_{\northo}=0
\end{align*}
%
We have
%
\begin{align*}
\sigma n = \mu\frac{\partial v}{\partial n} - p n + \mu \transpose{(\nabla v)} n
